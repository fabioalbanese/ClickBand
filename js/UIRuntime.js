...
const STYLES = {
    ...
    latin:{name:"Latin soft", bpm:116, melody:GM_COMPLETE.trumpet, arp:GM_COMPLETE.acousticGrandPiano, bass:GM_COMPLETE.acousticBass, guitar:GM_COMPLETE.acousticGuitar, pad:GM_COMPLETE.stringEnsemble1, counter:GM_COMPLETE.flute, ostinato:GM_COMPLETE.marimba, fx:GM_COMPLETE.agogo, choir:GM_COMPLETE.voiceOohs, brass:GM_COMPLETE.trombone, strings:GM_COMPLETE.stringEnsemble1, chromatic:0.48, bassMode:"latin", guitarMode:"sync", arpMode:"sync", drumMode:"latin", voices:{arp:true,guitar:true,bass:true,chromatic:true,drums:true,pad:false,counter:true,ostinato:true,fx:true,choir:false,brass:true,strings:false}, bars:{intro:4, verse:8, chorus:8, bridge:4, outro:4, solo:8}},
    ...
    jazz:{name:"🎷 Jazz", bpm:96, melody:GM_COMPLETE.altoSaxophone, arp:GM_COMPLETE.electricPiano2, bass:GM_COMPLETE.acousticBass, guitar:GM_COMPLETE.jazzGuitar, pad:GM_COMPLETE.drawbarOrgan, counter:GM_COMPLETE.trumpet, ostinato:GM_COMPLETE.acousticGrandPiano, fx:GM_COMPLETE.vibraphone, choir:GM_COMPLETE.voiceOohs, brass:GM_COMPLETE.brassSectionOrBrass, strings:GM_COMPLETE.stringEnsemble1, chromatic:0.72, bassMode:"jazz", guitarMode:"jazz", arpMode:"simple", drumMode:"jazz", voices:{arp:true,guitar:true,bass:true,chromatic:true,drums:true,pad:true,counter:true,ostinato:false,fx:true,choir:false,brass:true,strings:false}, bars:{intro:8, verse:12, chorus:12, bridge:8, outro:8, solo:8}},

    blues:{name:"🎸 Blues", bpm:88, melody:GM_COMPLETE.overdrivenGuitar, arp:GM_COMPLETE.drawbarOrgan, bass:GM_COMPLETE.fingerBass, guitar:GM_COMPLETE.jazzGuitar, pad:GM_COMPLETE.stringEnsemble1, counter:GM_COMPLETE.altoSaxophone, ostinato:GM_COMPLETE.electricPiano2, fx:GM_COMPLETE.guitarFretNoise, choir:GM_COMPLETE.voiceOohs, brass:GM_COMPLETE.trumpet, strings:GM_COMPLETE.stringEnsemble1, chromatic:0.62, bassMode:"blues", guitarMode:"blues", arpMode:"simple", drumMode:"blues", voices:{arp:true,guitar:true,bass:true,chromatic:true,drums:true,pad:true,counter:true,ostinato:false,fx:false,choir:false,brass:false,strings:false}, bars:{intro:8, verse:12, chorus:12, bridge:8, outro:8, solo:12}},
...
window.addEventListener("DOMContentLoaded", function() {
    ...
    const aiTemp = document.getElementById("cbMelTemp");
    const aiTempVal = document.getElementById("cbMelTempVal");
    if (aiTemp && aiTempVal) {
        aiTemp.addEventListener("input", function () {
            aiTempVal.textContent = Number(aiTemp.value).toFixed(1);
        });
    }
